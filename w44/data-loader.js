class MNISTDataLoader {
    ...
    /**
     * Add random Gaussian noise to image tensors.
     * @param {tf.Tensor} xs - Input images tensor [N, 28, 28, 1]
     * @param {number} noiseStddev - Standard deviation of the noise (default 0.3)
     * @returns {tf.Tensor} Noisy images clipped to [0, 1]
     */
    addNoise(xs, noiseStddev = 0.3) {
        return tf.tidy(() => {
            const noise = tf.randomNormal(xs.shape, 0, noiseStddev);
